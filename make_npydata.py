...
try:
    shanghaiAtrain_path = '/content/datasets/ShanghaiTech/part_A_final/train_data/images_crop'
    shanghaiAtest_path = '/content/datasets/ShanghaiTech/part_A_final/test_data/images_crop'
...
try:
    shanghaiBtrain_path = '/content/datasets/ShanghaiTech/part_B_final/train_data/images_crop'
    shanghaiBtest_path = '/content/datasets/ShanghaiTech/part_B_final/test_data/images_crop'
