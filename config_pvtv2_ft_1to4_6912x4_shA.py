...
parser.add_argument('--save_path', type=str, default='./save_file/ft_1to4_6912x4_shA_r6',
...
parser.add_argument('--test_dataset', type=str, default='UCF_QNRF',
                    help='choice train dataset')
parser.add_argument('--pre', type=str, default='./save_file/ft_1to4_6912x4_shA_r6/model_best.pth',#checkpoint.pth',
...
parser.add_argument('--lr', type=float, default=1e-5,
                    help='learning rate')
parser.add_argument('--model_type', type=str, default=None, #'token',
                    help='model type')
